  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-stone-900 to-amber-900">
      ...
      <div className="fixed top-20 right-6 z-30 space-y-4">
        <MemoryBubble memory="Teaching him to ride a bike was harder on me than him - watching him wobble away was my first lesson in letting go." author="Mike, Dad of 2" />
        <MemoryBubble memory="The first time she said 'I love you daddy' - nothing in the world has ever sounded sweeter." author="James, New Dad" />
      </div>
